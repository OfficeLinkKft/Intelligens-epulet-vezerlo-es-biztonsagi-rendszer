...
# Használat:
# python szemely_beengedo_video_clean.py --output ./videowithPersons.avi --encodings encodingsPersons.pickle -d hog
...
def carry_out_action(authorized_person):
    ...
    # A beengedéssal kapcsolatos interfész hívások helye
