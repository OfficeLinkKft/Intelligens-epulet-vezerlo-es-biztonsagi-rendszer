...
<html>
<head>
<title>Webkamer�k - Kom�rom-Esztergom megye</title>
<meta http-equiv="refresh" content="580;url=komarom.php">
...
//	$n=$_SESSION['nick'];
	$n='komarom';
		...
		elseif($n =='komarom') {
				$result = mysql_query("SELECT * FROM clients WHERE owner LIKE 'MK' AND county LIKE 'Kom�rom-Esztergom, M06' AND OFF!='OFF' ORDER BY id");
				$result2 = mysql_query("SELECT avg(avail28days) FROM clients WHERE owner LIKE 'MK' AND county LIKE 'Kom�rom-Esztergom, M06' AND OFF!='OFF'"); }

	$row2 = mysql_fetch_array($result2);	//result of system available data

	$nam='Kom�rom-Esztergom megye';
...
<div class="box">
	...
	<div class="header">
		...
		<div class="sw1">
			<a href="../clients_komarom.php" target="_blank">kliensek</a>
		</div>
		<div class="sw1">
			<a href="../map_komarom.php" target="_blank" title="t�rk�p"><img src="../images/map_tmb.png" width="27" height="18"></a>
		</div>
		<! ***** name  *****>
