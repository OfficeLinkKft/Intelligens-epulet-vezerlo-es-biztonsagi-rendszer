...
<html>
<head>
<title>Webkamer�k - BAZ megye</title>
<meta http-equiv="refresh" content="580;url=borsod.php">
...
//	$n=$_SESSION['nick'];
	$n='borsod';
		...
		elseif($n =='borsod') {
				$result = mysql_query("SELECT * FROM clients WHERE owner LIKE 'MK' AND county LIKE 'Borsod-Aba�j-Zempl�n, E06' AND OFF!='OFF' ORDER BY id");
				$result2 = mysql_query("SELECT avg(avail28days) FROM clients WHERE owner LIKE 'MK' AND county LIKE 'Borsod-Aba�j-Zempl�n, E06' AND OFF!='OFF'"); }

	$row2 = mysql_fetch_array($result2);	//result of system available data

	$nam='Borsod-Aba�j-Zempl�n megye';
...
<div class="box">
	...
	<div class="header">
		...
		<div class="sw1">
			<a href="../clients_borsod.php" target="_blank">kliensek</a>
		</div>
		<div class="sw1">
			<a href="../map_borsod.php" target="_blank" title="t�rk�p"><img src="../images/map_tmb.png" width="27" height="18"></a>
		</div>
		<! ***** name  *****>
