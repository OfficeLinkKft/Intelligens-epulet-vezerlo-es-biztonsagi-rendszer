...
<html>
<head>
<title>Webkamer�k - Gy�r-Moson-Sopron megye</title>
<meta http-equiv="refresh" content="580;url=gyor.php">
...
//	$n=$_SESSION['nick'];
	$n='gyor';
		...
		elseif($n =='gyor') {
				$result = mysql_query("SELECT * FROM clients WHERE owner LIKE 'MK' AND county LIKE 'Gy?r-Moson-Sopron, H06' AND OFF!='OFF' ORDER BY id");
				$result2 = mysql_query("SELECT avg(avail28days) FROM clients WHERE owner LIKE 'MK' AND county LIKE 'Gy?r-Moson-Sopron, H06' AND OFF!='OFF'"); }

	$row2 = mysql_fetch_array($result2);	//result of system available data

	$nam='Gy�r-Moson-Sopron megye';
...
<div class="box">
	...
	<div class="header">
		...
		<div class="sw1">
			<a href="../clients_gyor.php" target="_blank">kliensek</a>
		</div>
		<div class="sw1">
			<a href="../map_gyor.php" target="_blank" title="t�rk�p"><img src="../images/map_tmb.png" width="27" height="18"></a>
		</div>
		<! ***** name  *****>
