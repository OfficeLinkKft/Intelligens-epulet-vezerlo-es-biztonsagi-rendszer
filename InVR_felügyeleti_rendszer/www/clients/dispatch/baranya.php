...
<html>
<head>
<title>Webkamer�k - Baranya megye</title>
<meta http-equiv="refresh" content="580;url=baranya.php">
...
//	$n=$_SESSION['nick'];
	$n='baranya';
		...
		elseif($n =='baranya') {
				$result = mysql_query("SELECT * FROM clients WHERE owner LIKE 'MK' AND county LIKE 'Baranya, B06' AND OFF!='OFF' ORDER BY id");
				$result2 = mysql_query("SELECT avg(avail28days) FROM clients WHERE owner LIKE 'MK' AND county LIKE 'Baranya, B06' AND OFF!='OFF'"); }
...
<div class="box">
	...
	<div class="header">
		...
		<div class="sw1">
			<a href="../clients_baranya.php" target="_blank">kliensek</a>
		</div>
		<div class="sw1">
			<a href="../map_baranya.php" target="_blank" title="t�rk�p"><img src="../images/map_tmb.png" width="27" height="18"></a>
		</div>
		<! ***** name  *****>
