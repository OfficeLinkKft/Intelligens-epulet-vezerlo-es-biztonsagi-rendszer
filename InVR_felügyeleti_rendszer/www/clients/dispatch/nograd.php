...
<html>
<head>
<title>Webkamer�k - N�gr�d megye</title>
<meta http-equiv="refresh" content="580;url=nograd.php">
...
//	$n=$_SESSION['nick'];
	$n='nograd';
		...
		elseif($n =='nograd') {
				$result = mysql_query("SELECT * FROM clients WHERE owner LIKE 'MK' AND county LIKE 'N�gr�d, N06' AND OFF!='OFF' ORDER BY id");
				$result2 = mysql_query("SELECT avg(avail28days) FROM clients WHERE owner LIKE 'MK' AND county LIKE 'N�gr�d, N06' AND OFF!='OFF'"); }
...
<div class="box">
	...
	<div class="header">
		...
		<div class="sw1">
			<a href="../clients_nograd.php" target="_blank">kliensek</a>
		</div>
		<div class="sw1">
			<a href="../map_nograd.php" target="_blank" title="t�rk�p"><img src="../images/map_tmb.png" width="27" height="18"></a>
		</div>
		<! ***** name  *****>
