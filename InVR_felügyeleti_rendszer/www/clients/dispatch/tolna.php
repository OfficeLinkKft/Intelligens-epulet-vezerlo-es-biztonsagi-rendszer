...
<html>
<head>
<title>Webkamer�k - Tolna megye</title>
<meta http-equiv="refresh" content="580;url=tolna.php">
...
//	$n=$_SESSION['nick'];
	$n='tolna';
		...
		elseif($n =='tolna') {
				$result = mysql_query("SELECT * FROM clients WHERE owner LIKE 'MK' AND county LIKE 'Tolna, S06' AND OFF!='OFF' ORDER BY id");
				$result2 = mysql_query("SELECT avg(avail28days) FROM clients WHERE owner LIKE 'MK' AND county LIKE 'Tolna, S06' AND OFF!='OFF'"); }
...
<div class="box">
	...
	<div class="header">
		...
		<div class="sw1">
			<a href="../clients_tolna.php" target="_blank">kliensek</a>
		</div>
		<div class="sw1">
			<a href="../map_tolna.php" target="_blank" title="t�rk�p"><img src="../images/map_tmb.png" width="27" height="18"></a>
		</div>
		<! ***** name  *****>
