...
<html>
<head>
<title>Webkamer�k - Veszpr�m megye</title>
<meta http-equiv="refresh" content="580;url=veszprem.php">
...
//	$n=$_SESSION['nick'];
	$n='veszprem';
		...
		elseif($n =='veszprem') {
				$result = mysql_query("SELECT * FROM clients WHERE owner LIKE 'MK' AND county LIKE 'Veszpr�m, U06' AND OFF!='OFF' ORDER BY id");
				$result2 = mysql_query("SELECT avg(avail28days) FROM clients WHERE owner LIKE 'MK' AND county LIKE 'Veszpr�m, U06' AND OFF!='OFF'"); }
...
<div class="box">
	...
	<div class="header">
		...
		<div class="sw1">
			<a href="../clients_veszprem.php" target="_blank">kliensek</a>
		</div>
		<div class="sw1">
			<a href="../map_veszprem.php" target="_blank" title="t�rk�p"><img src="../images/map_tmb.png" width="27" height="18"></a>
		</div>
		<! ***** name  *****>
